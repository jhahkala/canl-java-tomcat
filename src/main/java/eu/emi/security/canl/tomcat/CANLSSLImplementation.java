...
/**
 * The main Tomcat 5 and 6 glue class, tomcat 7 is different, and will need another implementation
 * 
...
public class CANLSSLImplementation extends SSLImplementation {
     ...
     *             in case the util-java is not installed and thus
     *             ContextWrapper class isn't found.
     */
    public CANLSSLImplementation() throws ClassNotFoundException {
        ...
        try {
            this.getClass().getClassLoader().getResourceAsStream("META-INF/maven/eu.eu-emi.security/canl/pom.properties");
            props = new Properties();
            props.load(in);
            System.out.println("Tomcat pluging with canl v" + props.getProperty("version") + " starting.");
        } catch (Exception e) {
