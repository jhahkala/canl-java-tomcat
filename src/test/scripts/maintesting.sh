...
if [ x${os} == "xsl5" ] ; then
	...
	wget https://github.com/jhahkala/canl-java-tomcat/blob/gh-pages/packages/canl-java-tomcat-0.1.15-1.noarch.rpm?raw=true
elif  [ x${os} == "xsl6" ] ; then
	...
	wget https://github.com/jhahkala/canl-java-tomcat/blob/gh-pages/packages/canl-java-tomcat-0.1.15-1.el6.noarch.rpm?raw=true
fi
